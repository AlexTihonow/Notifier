...
func pollLoop(db *sql.DB, cfg Config, stop chan struct{}) {
	for {
...
func processBatch(db *sql.DB, cfg Config) bool {
...
func processEmail(db *sql.DB, cfg Config, m Mailing) {
...
func processPush(db *sql.DB, cfg Config, m Mailing) {
